...
# Tokenizer to split the vocab sentence into a list of tokens
...
# Creating the list of vocabulary from the vocabulary file
...
# Converting the sentence in tokens by calling the tokenizer function
...
# Creating token ids based on the data
